...
**The game is not ours.** *Monkey Academy* was published by **Konami** in 1984
as the RC-702 cartridge for the MSX. All rights over the game remain with their
holders.
...
The file `src/monkey.asm` is the commented disassembly of the cartridge. It
...
If you worked on *Monkey Academy* or hold rights over the game, and you would
