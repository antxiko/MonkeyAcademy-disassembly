...
**El juego no es nuestro.** *Monkey Academy* lo publicó **Konami** en 1984 como
cartucho RC-702 para MSX. Todos los derechos sobre el juego siguen siendo de
sus titulares.
...
El fichero `src/monkey.asm` es el desensamblado comentado del cartucho. Se
...
Si trabajaste en *Monkey Academy* o tienes derechos sobre el juego, y
