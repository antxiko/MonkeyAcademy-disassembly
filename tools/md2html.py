...
PIE = {
    "es": "<em>Monkey Academy</em> lo publico Konami en 1984 para MSX; su "
    ...
    "en": "<em>Monkey Academy</em> was published by Konami in 1984 for the "
...
def main(docdir, idioma="en"):
    ...
    for fn in sorted(os.listdir(docdir)):
        ...
        titulo = (m.group(1) if m else fn[:-3]) + " — Monkey Academy (1984)"
